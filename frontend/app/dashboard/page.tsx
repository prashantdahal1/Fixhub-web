...
// ── Icons (inline SVG to avoid any dep) ──────────────────────────────────────
const HomeIcon = () => (
    ...
    <div className="min-h-screen bg-[#F0F2F5] font-sans">
      ...
      <header className="bg-white border-b border-gray-200 px-6 h-14 flex items-center justify-between sticky top-0 z-40">
        ...
        <div className="flex items-center gap-2">
          {/* Wrench icon */}
          <div className="w-8 h-8 rounded-md bg-[#1D4ED8] flex items-center justify-center">
      ...
      <div className="flex min-h-[calc(100vh-56px)]">
        ...
        {/* ── SIDEBAR ── */}
        <aside className="w-44 bg-white border-r border-gray-100 flex-shrink-0 py-4">
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-start gap-4">
              <div className="flex-1">
                <h1 className="text-2xl font-bold text-gray-900">Hello, Prashant!</h1>
