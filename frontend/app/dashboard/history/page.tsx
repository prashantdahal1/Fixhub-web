...
export default function HistoryPage() {
  ...
  return (
    <div className="w-full space-y-6">
      ...
      {loading ? (
        <p className="text-xs font-medium text-slate-400 py-6 text-center">Loading history records...</p>
            ...
            >
              <div className="space-y-1">
                <div className="flex items-center gap-2.5 flex-wrap">
                  ...
                  <span className="font-mono text-[11px] font-semibold text-slate-400">#{orderNumber(b)}</span>
